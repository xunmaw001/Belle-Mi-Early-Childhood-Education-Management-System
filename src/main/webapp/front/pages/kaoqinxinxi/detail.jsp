				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>考勤编号：</span>
							<span class="desc">
								{{detail.kaoqinbianhao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>考勤项目：</span>
							<span class="desc">
								{{detail.kaoqinxiangmu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>考勤内容：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('kaoqinxinxi','考勤')" @click="onAcrossTap('kaoqinshenqing')" type="button" class="layui-btn">
								考勤
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`kaoqinxinxi`);
