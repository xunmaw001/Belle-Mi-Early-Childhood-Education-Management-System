	...
	<body style="background: #EEEEEE; ">
		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="zhaoshengrenshu" name="zhaoshengrenshu" placeholder="请输入招生人数" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">创办人：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="chuangbanren" name="chuangbanren" placeholder="请输入创办人" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                                                                <div class="layui-form-item layui-form-text">
