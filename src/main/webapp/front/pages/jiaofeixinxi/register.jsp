	...
	<body style="background: #EEEEEE; ">
		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="jiaofeixiangmu" name="jiaofeixiangmu" placeholder="请输入缴费项目" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">缴费金额：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="jiaofeijine" name="jiaofeijine" placeholder="请输入缴费金额" autocomplete="off" class="layui-input">
					</div>
				</div>
