		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.jiaofeixiangmu" type="text" name="jiaofeixiangmu" id="jiaofeixiangmu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">缴费金额：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiaofeijine" type="text" name="jiaofeijine" id="jiaofeijine" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                        ...
                                                                                                                                                                                    					                                        if(!isIntNumer(data.jiaofeijine)){
                        layer.msg('缴费金额应输入整数', {
							time: 2000,
							icon: 5
						});
