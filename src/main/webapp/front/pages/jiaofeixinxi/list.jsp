			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
							...
							<div class="layui-input-inline">
								<input type="text" name="jiaofeixiangmu" id="jiaofeixiangmu" placeholder="缴费项目" autocomplete="off" class="layui-input">
							</div>
						</div>   
						...
						<div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
							...
							<button v-if="isAuth('jiaofeixinxi','新增')" @click="jump('../jiaofeixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../jiaofeixinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
				...
				function pageList() {
					var param = {
						...
						param['xueshengxingming'] = jquery('#xueshengxingming').val() ? '%' + jquery('#xueshengxingming').val() + '%' : '';
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                if (jquery('#jiaofeixiangmu').val()) {
						param['jiaofeixiangmu'] = jquery('#jiaofeixiangmu').val() ? '%' + jquery('#jiaofeixiangmu').val() + '%' : '';
					}  
