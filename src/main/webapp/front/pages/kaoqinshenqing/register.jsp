		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="kaoqinbianhao" name="kaoqinbianhao" placeholder="请输入考勤编号" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">考勤项目：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="kaoqinxiangmu" name="kaoqinxiangmu" placeholder="请输入考勤项目" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">考勤内容：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="kaoqinneirong" name="kaoqinneirong" placeholder="请输入考勤内容" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
