		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
						...
						<div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
							...
							<button v-if="isAuth('banjixinxi','新增')" @click="jump('../banjixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../banjixinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
				...
				function pageList() {
					...
					// 获取列表数据
					http.request('banjixinxi/list', 'get', param, function(res) {
