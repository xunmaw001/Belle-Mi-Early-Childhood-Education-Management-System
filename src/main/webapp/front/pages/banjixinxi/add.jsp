		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="jiaoshixingming" id="jiaoshixingming" lay-filter="jiaoshixingming">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in jiaoshixingming" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/jiaoshixinxi/jiaoshixingming`,'get',{},(res)=>{
					vue.jiaoshixingming = res.data
				});
				form.on('select(jiaoshixingming)', (data) => {
					console.log(data.value);
					http.request('follow/jiaoshixinxi/jiaoshixingming', 'get', {
						columnValue: data.value
					}, function(res) {
																																										jquery("#xingbie").val(res.data.xingbie)
																								jquery("#lianxidianhua").val(res.data.lianxidianhua)
																	})
				});
