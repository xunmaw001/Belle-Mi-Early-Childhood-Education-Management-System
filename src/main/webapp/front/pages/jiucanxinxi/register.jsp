		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="zaocancaishi" name="zaocancaishi" placeholder="请输入早餐菜式" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">午餐菜式：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="wucancaishi" name="wucancaishi" placeholder="请输入午餐菜式" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">晚餐菜式：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="wancancaishi" name="wancancaishi" placeholder="请输入晚餐菜式" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                                                                                                                <div class="layui-form-item layui-form-text">
