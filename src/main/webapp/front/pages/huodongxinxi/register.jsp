		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="huodongbianhao" name="huodongbianhao" placeholder="请输入活动编号" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="huodongdizhi" name="huodongdizhi" placeholder="请输入活动地址" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                <div class="layui-form-item layui-form-text">
