...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>教学年龄</label>
										<input id="jiaoxuenianling" name="jiaoxuenianling" class="form-control" placeholder="教学年龄">
									</div>
									<div class="form-group col-md-6">
										<label>教学专业</label>
										<input id="jiaoxuezhuanye" name="jiaoxuezhuanye" class="form-control" placeholder="教学专业">
									</div>
									<div class="form-group col-md-6">
										<label>获得荣誉</label>
										<textarea name="huoderongyu" class="form-control" id="huoderongyu" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>相片</label>
	...
	<script>
		...
		function upload(){
			$('#xiangpianupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('xiangpian-input').setAttribute('value',baseUrl+"upload/"+data.result.file);
		...
		function dataBind(){
			...
			$("#jiaoxuenianling").val(ruleForm.jiaoxuenianling);	
			$("#jiaoxuezhuanye").val(ruleForm.jiaoxuezhuanye);	
			$("#huoderongyu").val(ruleForm.huoderongyu);
		...
		function showImg(){
			...
			$("#xiangpianImg").attr("src",ruleForm.xiangpian);
		}		
		//跨表
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiaoxuenianling != null && res.data.jiaoxuenianling != ''){

					$("#jiaoxuenianling").val(res.data.jiaoxuenianling);
					}
					if(res.data != null && res.data != '' && res.data.jiaoxuezhuanye != null && res.data.jiaoxuezhuanye != ''){

					$("#jiaoxuezhuanye").val(res.data.jiaoxuezhuanye);
					}
					if(res.data != null && res.data != '' && res.data.huoderongyu != null && res.data.huoderongyu != ''){

					$("#huoderongyu").val(res.data.huoderongyu);
					}
					if(res.data != null && res.data != '' && res.data.xiangpian != null && res.data.xiangpian != ''){

					$("#xiangpianImg").attr("src",res.data.xiangpian);
